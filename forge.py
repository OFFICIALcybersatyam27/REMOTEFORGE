...
# Author:            
# + SRY https://github.com/OFFICIALcybersatyam27
# Version:           v2.0
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(log_dir, "REMOTE_FORGE.log")),
...
def clear_screen():
   ...
   :0 0  :        {color_text('Remote Device Management', 'yellow')}
   : ^    `.      {color_text('Coded by SRY,OFFICIAL_cyber_satyam27', 'red')}
  :         ``.
 :             `.
:  :         .   `.
:   :          ` . `.
...
{color_text('⚡ RemoteForge v1.0 ⚡', 'blue')}
{color_text('Secure • Fast • Reliable', 'green')}
"""
    print(banner)
    logging.info(banner)
    ...
    try:
        ...
        while True:
            ...
            if choice == '1':
                ...
                logging.info("Exiting forge  Framework. Goodbye!")
                break
            else:
        ...
        logging.error("Exiting Forge Framework. Goodbye!")
